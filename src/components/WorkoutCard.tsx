  ...
  return (
    <Card className="overflow-hidden flex flex-col">
      ...
      <div className="bg-primary p-4 flex items-center justify-between">
        <h3 className="text-primary-foreground font-semibold text-sm line-clamp-1 flex-1">
          {title}
        </h3>
          ...
          <div className="flex items-center gap-2">
            ...
            <ChevronDown
              className={cn(
                ...
                isEquipmentOpen && "transform rotate-180"
              )}
            />
          </div>
        </button>
          ...
          <div className="flex justify-center gap-8 py-4">
            ...
            <div className="relative w-20 h-32">
              <svg viewBox="0 0 100 160" className="w-full h-full">
                ...
                {/* Muscle highlights */}
                {targetMuscles.front.includes("chest") && (
                  <ellipse cx="50" cy="55" rx="18" ry="12" fill="hsl(var(--muscle-highlight))" opacity="0.6" />
                )}
                {targetMuscles.front.includes("abs") && (
                  <rect x="42" y="65" width="16" height="15" fill="hsl(var(--muscle-highlight))" opacity="0.6" rx="2" />
                )}
                {targetMuscles.front.includes("quads") && (
                  <>
                    <rect x="38" y="85" width="8" height="40" fill="hsl(var(--muscle-highlight))" opacity="0.6" rx="4" />
                    <rect x="54" y="85" width="8" height="40" fill="hsl(var(--muscle-highlight))" opacity="0.6" rx="4" />
                  </>
                )}
              </svg>
            </div>
            ...
            <div className="relative w-20 h-32">
              <svg viewBox="0 0 100 160" className="w-full h-full">
                ...
                {/* Muscle highlights */}
                {targetMuscles.back.includes("back") && (
                  <ellipse cx="50" cy="55" rx="18" ry="15" fill="hsl(var(--muscle-highlight))" opacity="0.6" />
                )}
                {targetMuscles.back.includes("glutes") && (
                  <ellipse cx="50" cy="82" rx="16" ry="8" fill="hsl(var(--muscle-highlight))" opacity="0.6" />
                )}
                {targetMuscles.back.includes("hamstrings") && (
                  <>
                    <rect x="38" y="90" width="8" height="35" fill="hsl(var(--muscle-highlight))" opacity="0.6" rx="4" />
                    <rect x="54" y="90" width="8" height="35" fill="hsl(var(--muscle-highlight))" opacity="0.6" rx="4" />
                  </>
                )}
              </svg>
            </div>
